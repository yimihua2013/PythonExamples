...
def trip_cost(city,days):
	 return car_rental_cost(days)+hotel_cost(days)+flight_cost(city)
...
totalCost = trip_cost(trip_city, trip_length)
print "The total cost of your lovely trip will be %s, Bon Voyage! " %totalCost
